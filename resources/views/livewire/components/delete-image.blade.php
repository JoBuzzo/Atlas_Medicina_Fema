<div>
    ...
    <a wire:click='show' style="color:rgb(239 68 68)"
        class="cursor-pointer flex items-center  gap-2 px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
    ...
    @if ($show)
        <div
            ...
            <div
                class="absolute w-full h-full max-w-2xl p-4 transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                <!-- Modal content -->
                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <p class="text-blue-500">{{ $image->title }}</p>
